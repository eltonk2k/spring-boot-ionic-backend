...
import com.br.projeto.springbootmc.domain.Produto;
import com.br.projeto.springbootmc.domain.enums.EstadoPagamento;
import com.br.projeto.springbootmc.domain.enums.Perfil;
import com.br.projeto.springbootmc.domain.enums.TipoCliente;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "pbexecutores2@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Elton Silva", "pbexecutores@gmail.com", "27524278080", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("98754515", "32323232"));
		cli2.addPerfil(Perfil.ADMIN);
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriana Costa", "2001", null, "Centro", "58777012", cli2, c2);
